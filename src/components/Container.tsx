...
const navLinks = [
  ...
  { href: "#projects", text: "Find me" },
  { href: "#services", text: "Board" },
];
...
export default function Container(props: ContainerProps) {
  ...
  const meta = {
    title: "Zetsuna home page",
    description: `Content Creator for Genshin Impact and other Hoyoverse Games`,
    image: "/assets/icon-334x334.png",
    type: "website",
    ...customMeta,
  };
  ...
  return (
    <>
      <Head>
        ...
        <meta name="twitter:site" content="suna" />
        <meta name="twitter:title" content={meta.title} />
        <meta name="twitter:description" content={meta.description} />
        <meta name="twitter:image" content={meta.image} />
        <link rel="manifest" href="/manifest.json" />
        <link rel="apple-touch-icon" href="/icon-334x334.png" />
      </Head>
      <nav
        className={cn(
          styles.nav,
      ...
      >
        ...
        <Link href="/">
          <span className="text-lg font-semibold">suna</span>
        </Link>
